...
import com.project.shadowserver.shadowhunter.domain.gestionjeu.model.carte.equipement.AmuletteEquipement;

public class Amulette extends AbstractCarte {

    public Amulette() {
        this.setNomCarteEnum(NomCarteEnum.AMULETTE);
        this.setTypeEquipement(new AmuletteEquipement());
    }
