...
public class Attaque extends ActionAbstract {



    public Attaque(TerrainEnum terrainCible, PersonnageEnum emeteur, PersonnageEnum cible, TypeAction typeAction, OptionEnum option) {
