...
import com.project.shadowserver.shadowhunter.domain.gestionjeu.model.carte.equipement.TronconneuseDuMalEquipement;

public class TronconneuseDuMal extends AbstractCarte {

    public TronconneuseDuMal(){
        this.setNomCarteEnum(NomCarteEnum.TRONCONNEUSE_DU_MAL);
        this.setTypeEquipement(new TronconneuseDuMalEquipement());
    }
